...
<head>
	...
	<link href="<c:url value='/resources/jslibs/bootstrap-2.0.4/css/bootstrap.css'/>" rel="stylesheet">
	...
	<script src="<c:url value='/resources/jslibs/bootstrap-2.0.4/js/bootstrap.min.js'/>"></script>
